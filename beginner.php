...
<meta name="format-detection" content="telephone=no" />
		...
		<link rel="stylesheet" href="./css/theme-v3-green.css?v=mnavi38" type="text/css" media="screen">
	</head>
<body class="beginner">
...
<header>
		...
		<script>
			...
			$(document).ready(function() {
				$('.rentcheck input[type="checkbox"]').on('click', function() {
					...
					console.log($(this).val() + " の状態: " + $(this).is(':checked'));
				});
			});
		</script>
	</div>
	<section id="beginner-tips" class="v3-beginner-tips">
		<h2>初めてのカードローン<br>絶対に知るべき4つのコツ</h2>
		<div class="v3-beginner-tips-list">
			<details>
				<summary>1. 周囲に知られにくい方法を選ぶ！</summary>
				<p>Web完結やカードレス、郵送物なしの条件を確認すると、周囲に知られにくい形で進めやすくなります。</p>
			</details>
			<details>
				<summary>2. 初めてのご利用なら無利息期間を確認！</summary>
				<p>初回契約の方向けに、一定期間利息がかからないサービスが用意されている場合があります。</p>
			</details>
			<details>
				<summary>3. 返済額と返済方法を事前に見る！</summary>
				<p>毎月の返済額やATM・口座振込などの返済方法を先に確認して、無理のない使い方を選びましょう。</p>
			</details>
			<details>
				<summary>4. 借入までの時間は条件で変わる！</summary>
				<p>申込時間、審査状況、契約手続き、金融機関の対応時間によって借入までの時間は異なります。</p>
			</details>
		</div>
		<p class="v3-beginner-tips-note">※1 ご利用方法や状況によっては、ご家族や勤務先に通知が届く場合がございます。詳細は事前にご確認のうえ、ご利用ください。</p>
		<p class="v3-beginner-tips-note">※2 申し込みのカードローンによっては内容や条件が異なります。</p>
	</section>
	<section id="beginner-recommend" class="v3-beginner-lender-section">
		...
		<div class="v3-lender-card-list">
			<section class="v3-lender-card">
				...
				<dl class="v3-lender-specs">
					<div><dt>金利</dt><dd>2.4%～17.9%</dd></div>
			...
			<section class="v3-lender-card">
				...
				<dl class="v3-lender-specs">
					<div><dt>金利</dt><dd>2.5%～18.0%</dd></div>
					<div><dt>無利息期間</dt><dd>30日</dd></div>
	...
	<section>
		<div id="content1" class="ranking">
			<h2 class="content1_ttl v3-section-title">厳選！4つのコツを満たしたカードローンおすすめランキング</h2>
		</div>
		
		<div id="tab_1">
    <p class="active">人気順</p>
    <p>スピード順</p>
    <p>金利順</p>
</div>

<div id="display-area" style="text-align: center;"></div>
<script type="text/javascript">
    window.onload = function() {
        const tabs = document.querySelectorAll('#tab_1 p');
        ...
        tabs.forEach(tab => {
            tab.addEventListener('click', function() {
                ...
                displayArea.innerText = `${this.innerText}で表示しています。`;
            });
        });

        const initialActiveTab = document.querySelector('#tab_1 p.active');
        if (initialActiveTab) {
            displayArea.innerText = `${initialActiveTab.innerText}で表示しています。`;
        }
    };
...
<section class="hikaku_box" id="hikaku">
    <div class="c-compareTableWrapper u-mb-0 is-open">
        ...
        <div id="ranking2" class="topbox v3-beginner-select-ranking">
            ...
            <div id="tab_2" class="v3-beginner-rank-tabs" role="tablist" aria-label="比較ポイント">
                <button type="button" class="active" data-beginner-rank-tab="rate" aria-selected="true">金利</button>
                <button type="button" data-beginner-rank-tab="speed" aria-selected="false">スピード</button>
                <button type="button" data-beginner-rank-tab="privacy" aria-selected="false">バレにくさ<span class="caution">※</span></button>
                <button type="button" data-beginner-rank-tab="popular" aria-selected="false">人気</button>
            </div>
        ...
        <script>
            (function() {
                var root = document.getElementById('ranking2');
                if (!root) return;
                var tabs = Array.prototype.slice.call(root.querySelectorAll('[data-beginner-rank-tab]'));
                var panels = Array.prototype.slice.call(root.querySelectorAll('[data-beginner-rank-panel]'));
                tabs.forEach(function(tab) {
                    tab.addEventListener('click', function() {
                        var target = tab.getAttribute('data-beginner-rank-tab');
                        ...
                        panels.forEach(function(panel) {
                            panel.classList.toggle('active', panel.getAttribute('data-beginner-rank-panel') === target);
                        });
                    });
                });
            })();
	...
	<section>
		<div class="inner v3-point-grid">
            <div><span>1</span><strong>必要な金額を確認</strong><p>借りすぎを防ぎ、返済しやすい金額で比較。</p></div>
            <div><span>2</span><strong>申込条件を確認</strong><p>年齢や収入など、各社の条件を事前に確認。</p></div>
            <div><span>3</span><strong>返済計画を立てる</strong><p>月々の返済額と返済日を見て無理なく選択。</p></div>
        </div>
	</section>
...
<div class="timer_in_box">
	...
	<section>
		<div class="inner v3-point-grid">
            <div><span>1</span><strong>来店不要</strong><p>スマホから申込できるカードローンを比較。</p></div>
            <div><span>2</span><strong>スマホ完結</strong><p>本人確認から契約までWebで進めやすい会社を確認。</p></div>
            <div><span>3</span><strong>診断無料</strong><p>条件を選んでおすすめ順に確認。</p></div>
        </div>
	</section>
	<section>
		<div class="topbox topboxNew case">
