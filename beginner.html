...
<header>
	...
	<div id="search_box">
		<h2 class="ttl01">
			<i class="fas fa-search"></i> かんたん診断で絞り込む
		</h2>
	...
	<section>
		...
		<div id="flow" class="flow_cont">
			...
			<div class="toggle-section">
				<button class="toggle-btn">
					2. 初めてのご利用なら最大30日間利息ゼロ！ <span class="icon">＋</span>
				</button>
				<div class="toggle-content">
					<p>本サイトで紹介しているカードローンは「初めてのご利用で最大30日間利息0円」で、<span>初めての方でも安心</span>してご利用可能です。</p>
				</div>
			</div>

			<div class="toggle-section">
				<button class="toggle-btn">
					3. 毎月1,000円から無理なく返済！ <span class="icon">＋</span>
				</button>
				<div class="toggle-content">
					<p>月々の返済額が1,000円の少額からでも大丈夫なので、<span>自分のペースで無理なく</span>ご返済いただけます。</p>
				</div>
			</div>

			<div class="toggle-section">
				<button class="toggle-btn">
					4. 最短3分で借入完了！ <span class="icon">＋</span>
				</button>
				<div class="toggle-content">
					<p>スマホと<span>本人確認書類のみ</span>で<span>簡単WEB申込・最短3分</span>で借り入れいただけます。<span class="notes">※2</span> 24時間、土日祝も対応。</p>
				</div>
			</div>
			<div class="notes">
				<p>
					※1 ご利用方法や状況によっては、ご家族や勤務先に通知が届く場合がございます。詳細は事前にご確認のうえ、ご利用ください。
				</p>
				<p>
					※2 申し込みのカードローンによっては内容や条件が異なります。
				</p>
			</div>
		</div>
		<script>
